...
public class Product
{
	 ...
	 * @ordered
	 */
	public void basicSetLineItem(LineItem myLineItem) {
		if (this.lineItem != myLineItem) {
			if (myLineItem != null){
				if (this.lineItem != myLineItem) {
					LineItem oldlineItem = this.lineItem;
					this.lineItem = myLineItem;
					if (oldlineItem != null)
						oldlineItem.unsetProduct();
				}
			}
		}	
	}
	...
	public void setOrganization(Organization myOrganization) {
		...
		myOrganization.basicSetProduct(this);
	...
	public void setLineItem(LineItem myLineItem) {
		this.basicSetLineItem(myLineItem);
		myLineItem.basicSetProduct(this);
